...
public class SegundoJava {
  ...
  public SegundoJava(Ini ini) throws SQLException{
    ...
    // Criar novo registo na tabela ErroSensor quando necessário tendo em conta a tabela Sensor
    // Remocao de valores fora dos limites definidos na tabela Sensor
    // Criar novo registo na tabela Alerta quando necessario tendo em conta a tabela ParametroCultura
  ...
  public void connectToMySql() throws SQLException{
    ...
    Connection sql_connection_to = DriverManager.getConnection(ini.get("Mysql Destination","sql_database_connection_to"),ini.get("Mysql Destination","sql_database_user_to"),ini.get("Mysql Destination","sql_database_password_to"));
  }
  ...
  public void verificarTabelaSensor() throws SQLException{
    ...
    while(resultSet.next()){
        System.out.println("idsensor: " + resultSet.getInt(1) + " tipo: " + resultSet.getString(2) + " limiteinferior: " +  resultSet.getBigDecimal(3) + " limitesuperior: " + resultSet.getBigDecimal(4) + " idzona: " + resultSet.getInt(5));
    }
  }
